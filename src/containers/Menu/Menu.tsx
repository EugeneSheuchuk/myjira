  ...
  render() {
    ...
    return (
      <div className="Menu" style={{ width: `${this.state.width}px` }}>
        <MenuItem path="/" imgURL={Roadmap} name="Roadmap" tabIndex={0} />
        <MenuItem path="/" imgURL={Board} name="Board" tabIndex={0} />
        <MenuItem path="/" imgURL={Page} name="Pages" tabIndex={0} />
        {viewidLinks}
        <MenuItem path="/" imgURL={AddItem} name="Add item" tabIndex={0} />
        <MenuItem
          path="/"
          imgURL={Settings}
